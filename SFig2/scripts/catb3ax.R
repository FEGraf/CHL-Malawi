...
# this analysis uses two files (ref'd below) where I have just rerun
...
df_srst2_ecoli <-
  read_csv(here("data-raw/ariba_srst2_summary07092022.csv"))

df_srst2_kleb <-
  read_csv(here("data-raw/ariba-srst2-summary-dassim-musciha-kleb.csv"))
...
left_join(
  ...
  labs(title = "ARIBA assembly flag for CAT genes using SRST2")

ggsave(here("plots/ariba-srst2-assembly.pdf"), width = 8, height = 4)
