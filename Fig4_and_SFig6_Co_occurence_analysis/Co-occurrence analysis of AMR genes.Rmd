...
abricate_output <- read_csv(
  here("Fig4_and_SFig6_Co_occurence_analysis/data/all_abricate_773_Ec_Kp_CHL_Resfinder_L60_T90.csv"))

drug_class <- read_csv(
  here("Fig4_and_SFig6_Co_occurence_analysis/data/resfinder_phenotype_table_edit.csv"))
...
```{r Saving co-occurence matrix}
 ...
 write.csv(comat, file = here("Fig4_and_SFig6_Co_occurence_analysis/CoccuR_cooccurence_matrix.csv"))
