...
```{r}
f5.data <- read_csv(here("Fig5__data_frame_ST_comparison_Malawi_vs_100ST.csv"), col_types = "ffffnn")
```
...
```{r}
ggsave("Fig5.png", plot = f5.plot, height = 18, width = 32, units = "cm", dpi = 300)
